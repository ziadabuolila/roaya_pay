...
function Content() {
  ...
  return (
    <>
      <div class="GlowingBackdrop_glowingBackdrop__aM_VW">
        <svg
      ...
      >
        <div className="text-container reveal">
          <div className="name">
            <div className="typing-container" data-aos="fade-left">
              <span className="company-name">{t("company_name")}</span>
              <span> {t("the_rest_of_the_name")}</span>
            </div>
          </div>
        </div>
        ...
        <a href="#download" className="down">
          <button id="down">
        ...
        >
          ...
          <g className="parallax">
            <use
              ...
              x="48"
              y="0"
              fill="rgba(83,169,81,0.7)"
            ></use>
            <use
              xlinkHref="#gentle-wave"
              x="48"
              y="3"
              fill="rgba(83,169,81,0.5)"
            ></use>
            <use
              xlinkHref="#gentle-wave"
              x="48"
              y="5"
              fill="rgba(83,169,81,0.3)"
            ></use>
            <use xlinkHref="#gentle-wave" x="48" y="7" fill="#53a951"></use>
          </g>
        </svg>
      </div>

      <div className="app" id="download">
        <h2 className="reveal">{t("download_app_now")}</h2>
        <div className="about" data-aos="fade-up">
          <div className="app-text reveal">
            <div className="company-name-app reveal">
              <p>{t("app_roaya_pay")}</p>
            </div>

            <div className="app-description reveal">
              <p className="reveal">{t("discription_app")}</p>
            </div>

            <div className="app-stores reveal">
              <div className="google-play">
                <a href="https://play.google.com/store/apps/details?id=com.roaia.merchant&pcampaignid=web_share" target="_blank">
                  <img src="/app/google_play.jpg" alt="Roaya" />
                </a>
              </div>
              <div className="app_store">
                <a href="https://play.google.com/store/apps/details?id=com.roaia.merchant&pcampaignid=web_share" target="_blank">
                  <img src="/app/app_store.jpg" alt="Roaya" />
                </a>
              </div>
            </div>

            <a
              href="https://play.google.com/store/apps/details?id=com.roaia.merchant&pcampaignid=web_share"
              className="a_btn-download reveal" target="_blank"
            >
              <button className="btn-download comic-button">
                {t("download_now_app_roaya_pay")}
              </button>
            </a>
          </div>

          <div className="app-image reveal">
            <img src="/app/app.png" alt="Roaya" />
          </div>
        </div>
      </div>
    </>
